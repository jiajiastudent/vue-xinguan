    ...
    <div id="productCategroys">
            ...
            <template>
                ...
                >
                    ...
                    <el-table-column label="重量" width="80">
                        <template slot-scope="scope">
                            <el-tag type="success" size="mini" closable v-text="scope.row.weight+'kg'"></el-tag>
                        </template>
                    </el-table-column>
        ...
        <span>
          ...
          >
            ...
            <el-col :span="12">
                <div class="grid-content bg-purple">
                <el-form-item label="质量(kg)" prop="weight">
                        <el-input v-model="addRuleForm.weight"></el-input>
                </el-form-item>
                </div>
            </el-col>
            <el-col :span="12">
          ...
          <el-button type="primary" @click="add" :disabled="btnDisabled" :loading="btnLoading">确 定</el-button>
            ...
            <!-- 物资编辑弹出框 -->
            <el-dialog title="更新物资" :visible.sync="editDialogVisible" width="50%" @close="closeEditDialog">
        <span>
          <el-form
                  size="mini"
                  :model="editRuleForm"
              ...
              <el-col :span="12">
                <div class="grid-content bg-purple">
                  <el-form-item label="重量（kg）" prop="weight">
                    <el-input v-model="editRuleForm.weight"></el-input>
                  </el-form-item>
                </div>
              </el-col>
          </el-form>
