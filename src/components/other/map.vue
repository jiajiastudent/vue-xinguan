    ...
    <el-row :gutter="10">
      <el-col :span="8">
        <div class="grid-content bg-purple">
            <el-tabs type="border-card">
              <span style="font-size: 15px;">统计时间：{{times}}</span>
              ...
              <el-tab-pane label="TOP10城市" >
                <el-table height="495" border :data="top10" style="width: 100%;font-size: 10px;">
              <el-table-column prop="name" label="城市名称" >
              </el-table-column>
              <!--<el-table-column prop="ename" label="English"></el-table-column>-->
              <el-table-column prop="jwsrNum" label="确诊人数" >
                <template slot-scope="scope">
      ...
      <el-col :span="16">
        <div class="grid-content bg-purple-light">
          <el-card>
            <el-radio v-model="radio" label="1" style="padding-left: 400px" @change="changMap(radio)">确诊人数</el-radio>
